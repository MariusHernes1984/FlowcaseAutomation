"""Auth + SSE-consuming HTTP client used by the in-process eval runner.

Calls the same /api/chats endpoints as the CLI harness — simplest way
to exercise the agent without refactoring the orchestrator.
"""
...
from flowcase_web.eval.schema import ToolInvocation, Transcript
